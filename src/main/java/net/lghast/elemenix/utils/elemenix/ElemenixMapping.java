...
public class ElemenixMapping {
    ...
    static {
        ...
        ELEMENIX_MAP.put("#elemenix:strictly_unanalysable", new Constituents(true));
        ...
        ELEMENIX_MAP.put("#c:ores/zinc", new Constituents(Elemenix.TERRIX, 249));
        ...
        ELEMENIX_MAP.put("#c:ores/tin", new Constituents(Elemenix.TERRIX, 249));
        ...
        ELEMENIX_MAP.put("#c:ores/titanium", new Constituents(Elemenix.TERRIX, 168));
        ...
        ELEMENIX_MAP.put("#c:ores/lead", new Constituents(Elemenix.TERRIX, 375));
        ...
        ELEMENIX_MAP.put("#c:ores/tungsten", new Constituents(Elemenix.TERRIX, 627));
        ...
        ELEMENIX_MAP.put("#c:ores/osmium", new Constituents(Elemenix.TERRIX, 636));
        ELEMENIX_MAP.put("#c:ingots/osmium", new Constituents(0, 9, 0, 603, 0, 0));
        ELEMENIX_MAP.put("#c:raw_materials/osmium", new Constituents(Elemenix.TERRIX, 612));
        ...
        ELEMENIX_MAP.put("#c:ores/plutonium", new Constituents(0, 46, 0, 642, 0, 0));
        ELEMENIX_MAP.put("#c:ingots/plutonium", new Constituents(0, 22, 0, 612, 0, 0));
        ELEMENIX_MAP.put("#c:raw_materials/plutonium", new Constituents(Elemenix.TERRIX, 634));
        ...
        ELEMENIX_MAP.put("minecraft:dried_kelp", new Constituents(6, 0, 0, 0, 6, 0));
        ...
        ELEMENIX_MAP.put("#minecraft:bundles", new Constituents(Elemenix.ORGANIX, 56));
