...
public class ScanTrigger extends SimpleCriterionTrigger<ScanTrigger.Instance> {
    ...
    public static Criterion<Instance> scan() {
    ...
    public static final DeferredHolder<CriterionTrigger<?>, ScanTrigger> TRIGGER =
            TRIGGER_TYPES.register("scan", ScanTrigger::new);
}
