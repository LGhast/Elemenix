...
public class WaxOnTrigger extends SimpleCriterionTrigger<WaxOnTrigger.Instance> {
    ...
    public static Criterion<Instance> waxOn() {
    ...
    public static final DeferredHolder<CriterionTrigger<?>, WaxOnTrigger> TRIGGER =
            TRIGGER_TYPES.register("wax_on", WaxOnTrigger::new);
}
